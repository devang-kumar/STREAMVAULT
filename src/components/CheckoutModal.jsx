      ...
      >
          ...
          <div>
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <button
                ...
                className="btn-auth-submit w-full py-3.5 rounded-xl flex items-center justify-center gap-2 text-sm"
              >
        ...
        {step === 'success' && (
          <div className="px-6 py-12 flex flex-col items-center text-center">
            ...
            <button
              onClick={onClose}
              className="btn-auth-submit px-8 py-3 rounded-xl"
            >
              Start Watching
            </button>
          </div>
        ...
        {step === 'failure' && (
          <div className="px-6 py-12 flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-3 w-full">
              <button
                onClick={handleRetry}
                className="btn-auth-submit flex-1 py-3 rounded-xl"
              >
                Try Again
              </button>
              <button
