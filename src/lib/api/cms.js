...
export async function updateSeason(seriesId, seasonId, data) {
  console.log('=== API: updateSeason CALLED ===');
  console.log('  seriesId:', seriesId, '(type:', typeof seriesId + ')');
  console.log('  seasonId:', seasonId, '(type:', typeof seasonId + ')');
  console.log('  data:', data);
  console.log('  URL:', `/series/${seriesId}/seasons/${seasonId}`);
  return request(`/series/${seriesId}/seasons/${seasonId}`, {
    method: 'PATCH',
    body: JSON.stringify(data)
  })
...
export async function updateEpisode(episodeId, formData) {
  console.log('=== API: updateEpisode CALLED ===');
  console.log('  episodeId:', episodeId, '(type:', typeof episodeId + ')');
  console.log('  URL:', `/episodes/${episodeId}`);
