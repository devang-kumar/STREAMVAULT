      ...
      <div className="max-w-6xl mx-auto relative">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-xl font-bold text-sm transition-all mt-2 btn-auth-submit ${
                      !isSelected && 'bg-white/5 hover:bg-white/10 text-white'
                    }`}
                  >
                    {plan.cta}
                  </button>
        ...
        {plans.length > 0 && (
          ...
          <button
            ...
            className="btn-auth-submit px-12 py-4 rounded-xl text-lg"
          >
