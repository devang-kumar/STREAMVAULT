...
import { getEpisode, getEpisodes, getShow, saveWatchSession, trackActivity } from '../api/client'
...
export default function WatchPage() {
  ...
  // ── Analytics: save watch progress (debounced) ──
  useEffect(() => {
  ...
  }, [id, epId, currentTime, duration, progress])
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto py-2 px-2 space-y-1 scrollbar-thin">
              {episodes.map((ep) => {
                ...
                const isPremium = ep.premium && !isActive
