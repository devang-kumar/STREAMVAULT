...
export default function Dashboard() {
  ...
  const fetchData = useCallback(async () => {
    try {
      setLoading(true);
      const [seriesData, moviesData, adminData] = await Promise.allSettled([
        getSeries({ limit: 10 }),
        getMovies({ limit: 10 }),
  ...
  const statCards = [
    ...
    { label: 'Total Episodes', value: stats.totalEpisodes, icon: Eye, color: '#22c55e', trend: 12, trendLabel: 'this week' },
    { label: 'Total Users', value: stats.totalUsers, icon: UsersIcon, color: '#f97316', trend: 8, trendLabel: 'this month', onClick: () => navigate('/admin/users') },
  ];
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700 }}>Recent Series</span>
            </div>
            <button
              onClick={() => navigate('/admin/content/series')}
              style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700 }}>Recent Movies</span>
            </div>
            <button
              onClick={() => navigate('/admin/content/movies')}
              style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 600 }}>Platform Status</span>
        </div>
        <div style={{
