...
import {
  ...
  Check, AlertCircle, Monitor, Wifi, Lock, Eye, EyeOff,
  ChevronRight, RefreshCw, Download, Trash2
} from 'lucide-react';
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      ...
      <SettingSection icon={AlertCircle} title="Danger Zone" description="Irreversible actions" color="#ef4444">
        <SettingRow label="Clear Cache" description="Remove all cached data from the server">
          <button style={{
            display: 'flex', alignItems: 'center', gap: 6,
            padding: '8px 14px',
        ...
        <SettingRow label="Export Data" description="Download a backup of all platform data">
          <button style={{
            display: 'flex', alignItems: 'center', gap: 6,
            padding: '8px 14px',
            background: 'var(--bg-elevated)',
